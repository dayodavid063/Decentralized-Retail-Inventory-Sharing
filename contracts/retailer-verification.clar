...
;; This contract validates legitimate merchants in the system
...
(define-public (verify-retailer (retailer principal))
  (begin
    ...
    (asserts! (not (default-to false (map-get? verified-retailers retailer))) (err ERR-ALREADY-VERIFIED))
...
(define-public (revoke-verification (retailer principal))
  (begin
    (asserts! (is-admin) (err ERR-NOT-AUTHORIZED))
    (asserts! (default-to false (map-get? verified-retailers retailer)) (err ERR-NOT-VERIFIED))
